...
namespace System.Windows
{
    public static class DependencyObjectExtensions
    {
        ...
        /// <summary>
        /// Gets the first child of a specified type in the visual tree.
        /// </summary>
        /// <typeparam name="T">The type of the child to find.</typeparam>
        /// <param name="source">The starting point in the visual tree.</param>
        /// <returns>The first child of the specified type in the visual tree, or null if no such element exists.</returns>
        /// <exception cref="ArgumentNullException">Thrown when the source parameter is null.</exception>
